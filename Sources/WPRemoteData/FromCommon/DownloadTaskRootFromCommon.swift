...
extension DownloadTaskRoot {
    ...
    // SHOULD NOT BE PUBLIC IF POSSIBLE!!!
    public func callObservers(_ status: DownloadTaskRoot.Observable, downloadTaskSnapshot: DownloadTaskSnapshot){
...
extension DownloadTaskRoot {
    ...
    public enum DownloadError: ScorepioError {
        case noURL
